    ...
    return (
        <>
            ...
            <div className="grid md:grid-cols-3 grid-cols-2 gap-2 md:mb-20 mb-8">
                ...
                <img data-aos="zoom-in" data-aos-easing="ease-out-cubic" data-aos-duration="2000" src="https://i.ibb.co/ZBhnvfX/susan-g-komen-3-day-5-S1-S3-Mt-QVy-Q-unsplash.jpg" alt="" />
                <img data-aos="zoom-in" data-aos-easing="ease-out-cubic" data-aos-duration="2000" src="https://i.ibb.co/2ZgMmXV/samsung-memory-Tu8-F7ojdi-Eo-unsplash.jpg" alt="" />
                <img data-aos="zoom-in" data-aos-easing="ease-out-cubic" data-aos-duration="2000" src="https://i.ibb.co/R6Jrs6L/vlad-hilitanu-1-FI2-QAYPa-Y-unsplash.jpg" alt="" />
            </div>
        </>
