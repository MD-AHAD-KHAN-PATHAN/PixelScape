    ...
    return (
        <div className="min-h-screen m-20">
            ...
            <div className="collapse bg-base-200">
                ...
                <div className="collapse-content">
                    <p><span className="font-bold">2.1. Event Confirmation:</span> Event bookings are confirmed only upon receipt of a signed contract or agreement and the required deposit or payment.</p>
            ...
            <div className="collapse bg-base-200">
                ...
                <div className="collapse-content">
                    <p><span className="font-bold">3.1. Cancellation by the Customer:</span> If you wish to cancel an event, you must notify us in writing. The cancellation policy specified in your event contract will apply, and any deposits or payments may be forfeited.</p>
            ...
            <div className="collapse bg-base-200">
                ...
                <div className="collapse-content">
                    <p><span className="font-bold">4.1. Date and Time:</span> Requests for changes to the date and time of an event must be made in writing and are subject to availability. Additional fees may apply.</p>
            ...
            <div className="collapse bg-base-200">
                ...
                <div className="collapse-content">
                    <p><span className="font-bold">6.1. Liability: </span> We are not responsible for any loss, injury, damage, or theft of personal property that occurs during an event.</p>
            ...
            <div className="collapse bg-base-200">
                ...
                <div className="collapse-content">
                    <p><span className="font-bold">9.1. Governing Law: </span>These Terms and Conditions are governed by the laws of PixelScape.</p>
            ...
            <div className="collapse bg-base-200">
                ...
                <div className="collapse-content">
                    <p>We reserve the right to update or modify these Terms and Conditions at any time. Any changes will be effective upon posting on our website.</p>
                </div>
            </div>
        </div>
    );
